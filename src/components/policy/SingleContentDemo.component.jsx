...
const SingleContentDemo = () => (
  <>
    ...
    <p>
      At UniAdmissionPlatform, accessible from https://dqptgb5ddxe5e.cloudfront.net/, one of our main priorities is the
      privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded
      by UniAdmissionPlatform and how we use it.
    </p>
    ...
    <p>
      ...
      the information that they shared and/or collect in UniAdmissionPlatform. This policy is not applicable to any
    ...
    <p>
      UniAdmissionPlatform follows a standard procedure of using log files. These files log visitors when they visit
    ...
    <p>
      Like any other website, UniAdmissionPlatform uses 'cookies'. These cookies are used to store information including
    ...
    <p>
      You may consult this list to find the Privacy Policy for each of the advertising partners of UniAdmissionPlatform.
    </p>

    <p>
      Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
      their respective advertisements and links that appear on UniAdmissionPlatform, which are sent directly to users'
    ...
    <p>
      Note that UniAdmissionPlatform has no access to or control over these cookies that are used by third-party
      advertisers.
    </p>
    ...
    <p>
      UniAdmissionPlatform's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you
    ...
    <p>
      UniAdmissionPlatform does not knowingly collect any Personal Identifiable Information from children under the age
