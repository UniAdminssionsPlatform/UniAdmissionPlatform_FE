...
const PostCardCommentBtn = ({ className = 'flex px-3 h-8 text-xs', href, commentCount }) => {
  ...
  return (
    <Link
      ...
      <span className='ml-1 text-neutral-900 dark:text-neutral-200'>{comment.total}</span>
    </Link>
  );
};
