...
const PostCardLikeAction = ({ className = 'px-3 h-8 text-xs', postId, likeCount, isLiked, onClickLike = () => {} }) => (
  <button
    ...
    <svg width='24' height='24' fill={isLiked ? 'currentColor' : 'none'} viewBox='0 0 24 24'>
      <path
        fillRule='evenodd'
        stroke='currentColor'
        strokeLinecap='round'
