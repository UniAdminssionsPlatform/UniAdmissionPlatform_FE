  ...
  return (
    <div>
      ...
      >
        ...
        inventore possimus vitae, eveniet debitis ipsam vel? Doloremque
        assumenda atque consectetur. Delectus assumenda adipisci fugit nostrum
        inventore. Perspiciatis explicabo nihil animi!
      </div>
      <Layout>
        <Content
        ...
        >
          ...
          >
            ...
            >
              <Meta
                title="Nguyễn Đình Hào"
                description="Backend Developer - Team Leader"
              />
            </Card>
            <Card
              hoverable
        ...
        <Footer style={{ textAlign: 'center', backgroundColor: 'white' }}>
          Copyright ©2022 Created by Ant UED
        </Footer>
      </Layout>
    </div>
  )
