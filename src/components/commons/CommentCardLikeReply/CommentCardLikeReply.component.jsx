  ...
  const renderActionBtns = () => (
    <>
      <button
        ...
        title='Liked'>
        <svg className='h-5 w-5 mr-1' fill={isLiked ? 'currentColor' : 'none'} viewBox='0 0 24 24'>
          <path
            fillRule='evenodd'
            stroke='currentColor'
            strokeLinecap='round'
        ...
        <span className={`${isLiked ? 'text-rose-600' : 'text-neutral-900 dark:text-neutral-200'}`}>
