...
import ButtonClose from '../../field/ButtonClose/ButtonClose.component';
import ButtonDropdown from '../../commons/ButtonDropdown/ButtonDropdown.component';
...
const NcModal = ({
  ...
  function closeModal() {
    if (typeof isOpenProp !== 'boolean') setIsOpen(false);

    onCloseModal && onCloseModal();
  }

  function openModal() {
    if (typeof isOpenProp !== 'boolean') setIsOpen(true);
  }
  ...
  return (
    <div className='nc-NcModal'>
      {renderTrigger ? renderTrigger(openModal) : <ButtonDropdown onClick={openModal}> {triggerText} </ButtonDropdown>}
