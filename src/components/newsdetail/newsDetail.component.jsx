...
import SingleHeader4 from '../newsdetail/singleHeader4.component';
import { Spin } from 'antd';

const NewsDetailComponent = (props) => {
  const { newsdetail, loading } = props;
  return (
    <>
      <div>
          ...
          <div className={`nc-PageSingleTemp4Sidebar relative pt-10 lg:pt-16`} data-nc-id='PageSingleTemp4Sidebar'>
            ...
            <div className='relative'>
              ...
              <header className='container rounded-xl '>
                <SingleHeader4 newsdetail={newsdetail} />
              </header>

              {/* SINGLE MAIN CONTENT */}
              <div className='container flex flex-col my-10 lg:flex-row '>
                <div className='w-full lg:w-3/5 xl:w-2/3 xl:pr-20'>
                  <SingleContent newsdetail={newsdetail} />
                </div>
