...
import {
  ENDPOINT_COMMENT_EVENT_PUBLISH_BY_EVENT_ID, ENDPOINT_GET_A_NEW_PUBLISH,
  ENDPOINT_GET_COMMENT_BY_EVENT_PUBLISH_ID,
  ENDPOINT_GET_EVENT_PUBLISH_BY_ID
} from '../constants/Endpoints/PublishEndpoint';
//get event by id
export const getAEventPublishByIdService = (id) =>
    CallAPI(`${ENDPOINT_GET_EVENT_PUBLISH_BY_ID}${id}`, 'GET');
...
//get new by id
export const getANewPublishByEventIdService = (id) =>
    CallAPI(`${ENDPOINT_GET_A_NEW_PUBLISH}/${id}`, 'get');
