import { getHighSchoolRepresentatives } from '../../../../services/ManageProfileService';
...
import HighSchoolRepresentativesProfileComponent from './components/HighSchoolRepresentativesProfile.component';
import React, { useEffect, useState } from 'react';
import moment from 'moment';

const HighSchoolRepresentativesProfileContainer = () => {
  ...
  const accountDetail = (accountId) => {
    getHighSchoolRepresentatives().then((result) => {
      ...
      <div className={`nc-LayoutPage relative`} data-nc-id='LayoutPage'>
        <div className='container relative pt-10 pb-16 lg:pt-20 lg:pb-28'>
          ...
          <div className='p-5 mx-auto bg-white rounded-[40px] shadow-lg sm:p-10 mt-10 lg:mt-20 lg:p-16 dark:bg-neutral-900'>
            <HighSchoolRepresentativesProfileComponent
...
export default HighSchoolRepresentativesProfileContainer;
