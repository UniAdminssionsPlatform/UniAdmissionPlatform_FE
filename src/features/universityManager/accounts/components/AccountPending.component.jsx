...
const AccountPendingComponent = (props) => {
  const { data, setDataSearch, loading, setLoading, handleOk, total, onChangePage, dataSearch } = props;
  return (
    <>
      <div className='flex flex-col space-y-8 xl:space-y-0 xl:flex-row'>
        <div className='flex-shrink-0 max-w-xl xl:w-80 xl:pr-8'>
          <SearchBar setDataSearch={setDataSearch} setLoading={setLoading} dataSearch={dataSearch} />
        </div>
