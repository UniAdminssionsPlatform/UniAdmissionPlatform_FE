import {Button, DatePicker, Form, Input, Select, Typography, Upload, message, Divider} from 'antd';
                ...
                <div className='grid md:grid-cols-2 gap-6'>
                        ...
                        <label className='block md:col-span-2'>
                            <div className='grid gap-8 grid-cols-3'>
                                <div>
                                    ...
                                    <Form.Item name={['event', 'hostName']} rules={[
                                        {
                                            required: true,
                            ...
                            {eventType === 1 ?
                                <div>
                                    ...
                                    <Form.Item name={['event', 'meetingUrl']} rules={eventType === 1 ? [
                                        {
                                            required: true,
                                            message: 'Vui lòng nhập tên diễn giả'
                                        }
                            ...
                            {eventType !== 2 && eventType !== 1 ? <div className='grid gap-8 grid-cols-3'>
                                <div>
                                    <Label
                                        className='flex justify-between items-center text-neutral-800 dark:text-neutral-200'>
                                        Địa điểm tổ chức*
                                    </Label>
                                    <Form.Item name={['event', 'address']} rules={eventType === 3 || eventType === 4 ? [
                                        {
                                            required: true,
                                ...
                                <Form.Item name={['event', 'provinceId']} rules={eventType === 3 || eventType === 4 ? [
                                    {
                                        required: true,
                                ...
                                <Form.Item name={['event', 'districtId']} rules={eventType === 3 || eventType === 4 ? [
                                    {
                                        required: true,
                            ...
                            {eventType !== 2 ? <>
                                <div>
                                    ...
                                    <Form.Item name={['event', 'startTime']}
                                               rules={eventType === 1 || eventType === 3 || eventType === 4 ? [
                                                   {
                                                       required: true,
                    ...
                    <div className='block 2'>
                        <label className='block md:col-span-2'>
                            ...
                            <Label className='flex justify-between items-center text-neutral-800 dark:text-neutral-200'>Mô
                                tả</Label>
