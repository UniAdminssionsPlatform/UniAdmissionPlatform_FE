        ...
        <dl>
          {data.map((item, index) => (
            <div
              ...
              } px-4 py-5 sm:grid sm:grid-cols-2 sm:gap-4 sm:px-6`}>
              <dt className='text-sm font-medium text-neutral-500 dark:text-neutral-300'>{item.name}</dt>
              <dd className='mt-1 text-sm text-neutral-900 dark:text-neutral-200 font-medium sm:mt-0 sm:col-span-3'>
                {item.content}
              </dd>
            </div>
          ))}
...
export default HighSchoolInforComponent;
