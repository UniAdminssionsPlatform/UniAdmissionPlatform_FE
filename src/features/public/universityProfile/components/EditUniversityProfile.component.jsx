...
const UpdateUniversityProfileComponent = (props) => {
  ...
  const { onFinish, universityInformation, value, setValue, setImageUrl, setThumbnail } = props;
  const stylelabel = {
    paddingRight: '1px'
  };
  const field = [
    ...
    {
      name: ['description'],
      value: universityInformation.description
    }
  ];
            ...
            <div>
              {universityInformation === '' ? (
                ...
                <Image
                  ...
                  width={300}
                  height={300}
                  src={universityInformation.profileImageUrl}
                />
              )}
            </div>
          </div>
            ...
            <div>
              {universityInformation === '' ? (
                ...
                <Image
                  ...
                  width={300}
                  height={300}
                  src={universityInformation.thumbnailUrl}
                />
              )}
            </div>
          </div>
